...
public class JPushUtil {
    ...
    public static int sendToTagList(JPushClient jPushClient,List<String> tagsList, String msg_content,String extra, String extrasparam,String notification_title) {
        int result = 0;
        try {
            PushPayload pushPayload= buildPushObjectAllTagListAlertWithTitle(tagsList,msg_content,extra,extrasparam,notification_title);
            log.info(""+pushPayload);
            PushResult pushResult=jPushClient.sendPush(pushPayload);
            log.info(""+pushResult);
            if(pushResult.getResponseCode()==200){
    ...
    public static int sendToAllAndroid(JPushClient jPushClient, String notification_title,  String msg_content,String extraKey, String extrasparam) {
        int result = 0;
        try {
            PushPayload pushPayload= buildPushObjectAllAndroidAlertWithTitle(notification_title,msg_content,extraKey,extrasparam);
            log.info(""+pushPayload);
            PushResult pushResult=jPushClient.sendPush(pushPayload);
            log.info(""+pushResult);
            if(pushResult.getResponseCode()==200){
    ...
    public static int sendToAllIos(JPushClient jPushClient, String msg_content,String extraKey, String extrasparam) {
        int result = 0;
        try {
            PushPayload pushPayload= buildPushObjectAllIosWithTitle(msg_content,extraKey,extrasparam);
            log.info(""+pushPayload);
            PushResult pushResult=jPushClient.sendPush(pushPayload);
            log.info(""+pushResult);
            if(pushResult.getResponseCode()==200){
...
//                                .setAlert(notification_title)
     ...
     * @return
     */
    private static PushPayload buildPushObjectAllTagListAlertWithTitle(List<String> tagsList,  String msg_content,String extraKey, String extrasparam,String notification_title) {
     ...
     * @return
     */
    private static PushPayload buildPushObjectAllAndroidAlertWithTitle(String notification_title,  String msg_content,String extraKey, String extrasparam) {
     ...
     * @return
     */
    private static PushPayload buildPushObjectAllIosWithTitle(  String msg_content,String extraKey, String extrasparam) {
